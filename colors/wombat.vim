...
" Diff colors
hi DiffAdd                    guibg=#244024 ctermfg=black ctermbg=192 cterm=none
hi DiffText                   guibg=#323264 ctermfg=black ctermbg=105 cterm=none
hi DiffChange                 guibg=#303030 ctermfg=black ctermbg=Grey
hi DiffDelete   guifg=#802020 guibg=#242424 ctermfg=black ctermbg=203 cterm=none

" Console Error Colors
hi SpellBad cterm=underline ctermbg=052
hi SpellCap cterm=underline ctermbg=058
